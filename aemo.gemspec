...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency 'jeweler',       '~> 2.1', '>= 2.1.0'
  ...
  s.add_development_dependency 'guard-yard',    '~> 2.1', '>= 2.1.4'
  s.add_development_dependency 'webmock',       '~> 2.0', '>= 2.0.0'
  s.add_development_dependency 'rubocop',       '~> 0.39','>= 0.39.0'
end
