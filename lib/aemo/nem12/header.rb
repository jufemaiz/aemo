  ...
  class NEM12
    ...
    class Header
      ...
      def self.parse_csv(csv_string)
        ...
        raise ArgumentError, "CSV string '#{csv_string}' does not meet specification" unless csv_string =~ /^100,NEM12,\d{12},[A-Z0-9]{1,10},[A-Z0-9]{1,10}$/i
